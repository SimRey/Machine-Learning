...
numerical_transformer = Pipeline(steps=[('imputer', SimpleImputer(
    strategy='constant'))])  # In this case constant can be changed to mean, median, mode, etc...
...
# Finally, we use the Pipeline class to define a pipeline that bundles the preprocessing and modeling steps. There are
